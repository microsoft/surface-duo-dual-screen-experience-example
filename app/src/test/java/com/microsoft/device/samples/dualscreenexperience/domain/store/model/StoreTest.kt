...
import com.microsoft.device.samples.dualscreenexperience.domain.store.testutil.BIANCA_KEY
import com.microsoft.device.samples.dualscreenexperience.domain.store.testutil.CESAR_KEY
import com.microsoft.device.samples.dualscreenexperience.domain.store.testutil.CRISTIAN_KEY
import com.microsoft.device.samples.dualscreenexperience.domain.store.testutil.GUY_KEY
import com.microsoft.device.samples.dualscreenexperience.domain.store.testutil.HAKON_KEY
import com.microsoft.device.samples.dualscreenexperience.domain.store.testutil.JOY_KEY
import com.microsoft.device.samples.dualscreenexperience.domain.store.testutil.MEHUL_KEY
