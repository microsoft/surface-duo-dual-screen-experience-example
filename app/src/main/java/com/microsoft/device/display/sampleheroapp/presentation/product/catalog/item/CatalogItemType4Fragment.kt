...
@AndroidEntryPoint
class CatalogItemType4Fragment : CatalogItemFragment() {

    companion object {

        fun createInstance(catalogItem: CatalogItem, pageNo: Int, totalPages: Int) =
            CatalogItemType4Fragment().apply {
    ...
    private var binding: FragmentCatalogItemType4Binding? = null
    ...
    override fun onCreateView(
        ...
        binding = FragmentCatalogItemType4Binding.inflate(inflater, container, false)
