...
@AndroidEntryPoint
class CatalogItemType3Fragment : CatalogItemFragment() {

    companion object {

        fun createInstance(catalogItem: CatalogItem, pageNo: Int, totalPages: Int) =
            CatalogItemType3Fragment().apply {
    ...
    private var binding: FragmentCatalogItemType3Binding? = null
    ...
    override fun onCreateView(
        ...
        binding = FragmentCatalogItemType3Binding.inflate(inflater, container, false)
